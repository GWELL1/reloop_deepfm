...
from src.deepfm_reloop import ModelBuilder, AUCMetric, DeepFMModel, PredictWithSigmoid
...
def train_deepfm():
    ...
    listds = ms.Tensor(np.zeros((steps_size, config.batch_size, 1)), ms.float32)
    i = 0
