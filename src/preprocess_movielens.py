...
def random_split_trans2mindrecord(input_file_path, output_file_path, recommendation_dataset_stats_dict,
    ...
    writer_train.add_schema(schema, "MOV_TRAIN")
    writer_test.add_schema(schema, "MOV_TEST")
...
if __name__ == '__main__':
    ...
    data_file_path = data_path + "origin_data/data.txt"
    ...
    in_file_path = data_path + "origin_data/data.txt"
